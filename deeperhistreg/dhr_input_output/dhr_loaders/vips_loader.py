...
class VIPSLoader(WSILoader):
    ...
    def __init__(self, image_path, mode=LoadMode.NUMPY):
        ...
        self.mode = mode
        self.image = pyvips.Image.new_from_file(self.image_path)
    ...
    def get_resolutions(self) -> Iterable[int]:
        ...
        for level in range(self.num_levels):
            if self.num_levels > 1:
                image = pyvips.Image.new_from_file(self.image_path, page=level)
            else:
    ...
    def get_best_level(self, resample_ratio : float) -> pyvips.Image:
        ...
        if self.num_levels == 1:
            ...
            for i, resolution in enumerate(self.resolutions):
                ...
                current_level = i
            if current_level == 0:
                return pyvips.Image.new_from_file(self.image_path), current_level
            else:
                return pyvips.Image.new_from_file(self.image_path, page=current_level), current_level
